...
<Callout icon="📘" theme="info">
  ...
  Please note: While ITFlow generally discourages submitting AI-generated code or documentation, AI is used here to generate the OpenAPI specification files from the API code and database schema, with human oversight.
